...
int gausmat4_solve(long int mcmax, long int mcmin)
...
int gausmat4_add(long int mcmax, long int mcmin,int wn[], double wi[])
...
int gausmat3(int am, long int mcmax, long int mcmin,int wn[], double wi[])
        /* wn[] - line koef numbers */
        /* wi[] - line koef values */
 ...
 *                                                                 */
        ...
        nempty=0;
        if (printmod) {printf("TOTAL BAND MATRIX SIZE: val0[%ld]\n",pos0cur); }
        /*
 *         */
